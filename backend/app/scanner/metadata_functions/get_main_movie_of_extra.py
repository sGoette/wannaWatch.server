...
async def get_main_movie_of_extra(absolute_file_path: Path, main_movie_file_name: str, extra_movie: Movie, library_id: int) -> Optional[Movie]:
...
""", (f"{main_movie_file_location}%", library_id, extra_movie.id)) as cursor:
